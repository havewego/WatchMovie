  ...
  ================================================== -->
    ...
    function search() {
		$.ajax({
			...
			data:{"name":$("#searchname").val(),"page":1},
			success:function(data){
				...
				for(var j=0; j<parseInt(page);j++){
					if(j==0){
						...
						st +="<a href='${pageContext.request.contextPath}/looksearch?page="+(j+1)+"&name="+data["moviename"]+"' class='page gradient'>"+(j+1)+"</a>";
					}
				}
				$("#page").empty();
				$("#page").append(st);
    	...
    	$(function(){
    		...
    		$.ajax({
				type:"post",
				url:"${pageContext.request.contextPath }/allmovie",
				...
				success:function(data){
					...
					for(var j=0; j<parseInt(page);j++){
						...
						if(j==0){
							...
							st +="<a href='${pageContext.request.contextPath}/lookall?page="+(j+1)+"' class='page gradient'>"+(j+1)+"</a>";
						}
					}
					$("#page").empty();
					$("#page").append(st);
			...
			<div class="col-1-3">
				<div class="wrap-col f-right">
					<form id="search">
					  ...
					  <input class="search" type="button" value="search" onclick="search()"/>
					</form>
				</div>
			</div>
			<div class="col-1-3">
